...
int main(){
    sleep(2);
    printf("\n\n\n");
    //Q1. write a c program to print your name , roll no. , branch:
    long long roll_no = 301902222002;
    char name[] = "Saket Verma";
    char branch[] = "CSE" ;
    printf("I am %s and my roll no. is %lld and i am from %s branch.\n\n\n",name , roll_no , branch);
    ...
    printf("\n\n\n");
     ...
     int day;
     printf("Enter the number of day in the week.(week starts with sunday)");
     scanf("%d",&day);
     switch (day)
     {
        case 1:
        ...
        case 7:
            ...
            break;
        default:
            printf("Invalid day dont you know there are only 7 days in a week!");
            break;
     }
     sleep(2);
     printf("\n\n\n");
     ...
     printf("The '=' operator is an assigment operator which is used to assign a value to a variable.\nWhile the '==' opertor is a comparison operator which is used to compare two value that they are equal to each other or not.");
