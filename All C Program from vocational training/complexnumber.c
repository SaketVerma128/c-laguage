...
int main()
{
    ...
    c3 = plus(c1, c2);
    printf("the sum of your first and second complex number as a + ib is %f + i%f\n", c3.realnum, c3.imaginarynum);

    c4 = minus(c1, c2);
    printf("the substraction of your first and second complex number as a + ib is %f + i%f\n", c4.realnum, c4.imaginarynum);
}