...
int main (){
    ...
    //4 swap two variable using temporary variable
    int a = 10,b = 20,c;
    ...
    //5 swap two variable without using temporary variable
    int g = 3, h =5;
    printf("the first value is %d and second value is %d\n",g ,h);
    g = g+h;
    h = g-h;
    ...
    //8 multiply two integer 
    int aa = 12 , bb = 3 ,cc;
    cc = aa*bb;
    printf("the multiplication of %d and %d is %d\n\n",aa,bb,cc);

    //9 find the average of two number
    int d = 34,e = 53;
    float f = (d+e)/2;
